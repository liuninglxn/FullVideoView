...
public class UUUtils {
    ...
    public static void setRequestedOrientation(Context context, int orientation) {
        if (UUUtils.getAppCompActivity(context) != null) {
            UUUtils.getAppCompActivity(context).setRequestedOrientation(
                    orientation);
        } else {
            UUUtils.scanForActivity(context).setRequestedOrientation(
                    orientation);
        }
    }
    ...
    public static Window getWindow(Context context) {
        if (UUUtils.getAppCompActivity(context) != null) {
            return UUUtils.getAppCompActivity(context).getWindow();
        } else {
            return UUUtils.scanForActivity(context).getWindow();
        }
    }
    ...
    public static void hideStatusBar(Context context) {
        if (UUvideo.TOOL_BAR_EXIST) {
            UUUtils.getWindow(context).setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        }
    }
    ...
    public static void hideSystemUI(Context context) {
        ...
        SYSTEM_UI = UUUtils.getWindow(context).getDecorView().getSystemUiVisibility();
        UUUtils.getWindow(context).getDecorView().setSystemUiVisibility(uiOptions);
...
//                        | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        ...
        UUUtils.getWindow(context).getDecorView().setSystemUiVisibility(SYSTEM_UI);
    }
