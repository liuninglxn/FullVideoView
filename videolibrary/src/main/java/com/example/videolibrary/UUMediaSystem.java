 ...
 * 实现系统的播放引擎
 */
public class UUMediaSystem extends UUMediaInterface implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {

    public MediaPlayer mediaPlayer;

    public UUMediaSystem(UUvideo jzvd) {
        super(jzvd);
    }
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            try {
                ...
                mediaPlayer.setOnPreparedListener(UUMediaSystem.this);
                mediaPlayer.setOnCompletionListener(UUMediaSystem.this);
                mediaPlayer.setOnBufferingUpdateListener(UUMediaSystem.this);
                mediaPlayer.setScreenOnWhilePlaying(true);
                mediaPlayer.setOnSeekCompleteListener(UUMediaSystem.this);
                mediaPlayer.setOnErrorListener(UUMediaSystem.this);
                mediaPlayer.setOnInfoListener(UUMediaSystem.this);
                mediaPlayer.setOnVideoSizeChangedListener(UUMediaSystem.this);
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, final int what, final int extra) {
        handler.post(() -> {
            if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
                if (jzvd.currentState == UUvideo.CURRENT_STATE_PREPARING
                        || jzvd.currentState == UUvideo.CURRENT_STATE_PREPARING_CHANGING_URL) {
                    jzvd.onPrepared();
                }
            } else {
